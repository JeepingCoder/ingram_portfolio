  ...
  return (
    ...
    >
      <div className="max-w-[1100px] mx-auto p-2 flex flex-col justify-center w-full h-full">
        <div>
          <div className="pb-8">
            <p className="text-4xl font-bold inline broder-b-4 border-[#ad8f18]">
              Applications
            </p>
          </div>
          {/* card element */}
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            >
              <div>
                <div>
                  <a
                    href="https://github.com/JeepingCoder/pre-trip-plus"
                    class="relative inline-flex items-center justify-start px-5 py-3 overflow-hidden font-med transition-all bg-blue-600 rounded-full hover:bg-white group"
                  >
