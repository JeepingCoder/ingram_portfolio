        ...
        <div>
          <div className="sm-text-right pb-8 pl-4 ">
            ...
            <form method="post" action="https://getform.io/f/954c3c53-a1ec-43ee-ad21-2da1e3bceb76" className="flex flex-col max-w-[800px] w-full">
              <div>
                <p className="text-gray-500 text-2xl pl-4 py-4">I can't wait to here from you:</p>
              </div>
              <input className="text-black placeholder-gray-600 rounded-md p-2 bg-[#ad8f18]" type="text" placeholder="Name" name="name"/>
              <input className="text-black placeholder-gray-600 rounded-md my-4 p-2 bg-[#ad8f18]" type="email" placeholder="Email" name="email"/>
              <textarea className="text-black placeholder-gray-600 rounded-md p-2 bg-[#ad8f18] " name="message" rows="5" placeholder="Message"></textarea>
